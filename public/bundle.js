...
/***/ function(module, exports, __webpack_require__) {
	...
	var Stroy = __webpack_require__(177);
	...
	var Home = React.createClass({
	  ...
	  componentDidMount: function componentDidMount() {
	    ...
	    axios.get('https://hacker-news.firebaseio.com/v0/topstories.json?print=pretty').then(function (response) {
	      var stories = response.data.slice(0, 30) || [];
	      _this.setState({
	        news: stories
	      });
	    });
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            ...
	            this.state.news.map(function (id) {
	              return React.createElement(Stroy, { id: id, key: id });
	            })
	          )
	        )
	      ),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Story = React.createClass({
	  ...
	  componentDidMount: function componentDidMount() {
	    ...
	    axios.get('https://hacker-news.firebaseio.com/v0/item/' + this.props.id + '.json?print=pretty').then(function (res) {
	      _this.setState({
	        story: res.data || {}
	      });
	    });
	  ...
	  render: function render() {
	    var _state$story = this.state.story;
	    var by = _state$story.by;
	    var score = _state$story.score;
	    var time = _state$story.time;
	    var title = _state$story.title;
	    var url = _state$story.url;
	    var descendants = _state$story.descendants;

	    var readableTime = Math.floor((new Date().getTime() - time * 1000) / 3600000);
	    return React.createElement(
	      'li',
	      { className: 'ListItem' },
	      React.createElement(
